...
<head>
    ...
    <title>Reports — A-Rent System</title>
    ...
    <style>
        * { font-family: 'Poppins', sans-serif; box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .table-header { padding: 18px 24px; border-bottom: 1px solid #f1f5f9; display: flex; justify-content: space-between; align-items: center; }
        .table-title { font-size: 1rem; font-weight: 700; color: #0f172a; }
        .btn-export { background: #e8b4b8; color: #1a1a2e; padding: 8px 18px; border-radius: 8px; font-weight: 700; text-decoration: none; font-size: 0.82rem; transition: background 0.2s; }
        .btn-export:hover { background: #d4929a; }
...
<body>
    <div class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="{{ route('reports.index') }}" class="nav-item active"><span>📊</span> Reports</a>
        </nav>
    </div>
    ...
    <div class="topbar">
        <div class="topbar-links">
            ...
            <a href="{{ route('reports.index') }}" class="topbar-link active">Reports</a>
        </div>
    ...
    <div class="main">
        ...
        <div class="stats-grid">
            <div class="stat-card">
                ...
                <div class="stat-value" style="color: #16a34a;">₱{{ number_format($totalIncome, 2) }}</div>
            </div>
            <div class="stat-card">
            ...
            <div class="stat-card">
                ...
                <div class="stat-value" style="color: #d97706;">{{ $activeRentals }}</div>
            </div>
        </div>

        <div class="table-card">
            <div class="table-header">
                <div class="table-title">Rental History</div>
                <a href="{{ route('reports.index') }}" class="btn-export">⬇ Export</a>
            </div>
            <table>
                <thead>
                    <tr>
                ...
                <tbody>
                    ...
                    @empty
                    <tr>
                        <td colspan="7" style="text-align:center; color:#94a3b8; padding:40px;">No rental history found.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
